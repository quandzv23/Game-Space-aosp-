...
# Sửa bug: video chỉ reset lại khi Force Stop -> nay reset đúng lúc vuốt khỏi Recents
...
cat > app/src/main/java/com/quandzv23/gamespace/GameWatcherService.kt << 'QSPACE_EOF'
package com.quandzv23.gamespace
