...
class MainActivity : AppCompatActivity() {
    ...
    private fun playEntranceAnimation() {
        ...
        // DEBUG TẠM: xác nhận có đọc được URI đã lưu hay không.
        Toast.makeText(this, "Intro URI đã lưu: ${introUriString ?: "KHÔNG CÓ"}", Toast.LENGTH_LONG).show()
        ...
        return try {
            ...
            player.addListener(object : Player.Listener {
                override fun onPlaybackStateChanged(playbackState: Int) {
                    // DEBUG TẠM: báo trạng thái để biết chỗ nào bị kẹt.
                    // Xóa 4 dòng Toast này sau khi tìm ra nguyên nhân.
                    ...
                    Toast.makeText(this@MainActivity, "Video state: $stateName", Toast.LENGTH_SHORT).show()
                ...
                override fun onPlayerError(error: androidx.media3.common.PlaybackException) {
                    // DEBUG TẠM: hiện lỗi thật ra màn hình để biết chính xác vì sao không phát được.
                    Toast.makeText(
                        this@MainActivity,
                        "Lỗi phát video: ${error.errorCodeName} — ${error.message}",
                        Toast.LENGTH_LONG
                    ).show()
                    finishIntroVideo(overlay, playerView, player)
                }
            ...
            // DEBUG TẠM
            Toast.makeText(this, "Exception khi tạo player: ${e.message}", Toast.LENGTH_LONG).show()
