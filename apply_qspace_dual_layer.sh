...
# Video dọc: thêm lớp nền zoom mờ + lớp chính fit không cắt -> nhìn full màn hình mà không mất nội dung
...
<androidx.coordinatorlayout.widget.CoordinatorLayout
    ...
    <FrameLayout
        ...
        <!-- Lớp NỀN: video zoom phủ kín màn hình, làm tối đi để chỉ đóng vai trò lấp
             khoảng trống hai bên — bị cắt cũng không sao vì đây chỉ là trang trí. -->
        <androidx.media3.ui.PlayerView
            android:id="@+id/open_intro_video_bg"
            android:layout_width="match_parent"
            android:layout_height="match_parent"
            android:alpha="0.45"
        ...
        <View
            android:id="@+id/open_intro_video_scrim"
            android:layout_width="match_parent"
            android:layout_height="match_parent"
            android:background="#66000000"
            android:visibility="gone" />

        <!-- Lớp CHÍNH: cùng video, hiện "fit" đủ 100% nội dung, không cắt, đặt giữa màn hình. -->
        <androidx.media3.ui.PlayerView
